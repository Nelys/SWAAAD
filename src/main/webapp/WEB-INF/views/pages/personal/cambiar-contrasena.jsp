		...
		<div class="im-centered">
			<div class="row">
				<div class="col-lg-12">
					...
					<form name='docenteForm' id='docenteForm' action="registrarUsuario"
						...
						<div class="form-group ">
							<label for="password" class="sr-only">Nuevo Contraseña</label> <input
								type="password" class="form-control" name="password"
								id="password" placeholder="Nuevo Password" value=""
								required="required" />
						</div>
						<div class="form-group ">
							<label for="password" class="sr-only">Confirmar Contraseña</label> <input
								type="password" class="form-control" name="password2"
								id="password2" placeholder="Confirmar Password" value=""
								required="required" />
						</div>

						<div class="form-group ">
							<!-- 						<button type="submit" name="signup" class="btn btn-primary" disabled="disabled">Guardar</button> -->
							<a href="perfil" class="btn btn-primary">Cancelar</a> <a
								href="perfil" class="btn btn-success pull-right">Guardar</a>
						</div>
					</form>
				</div>
			</div>
