					...
					<form name='docenteForm' id='docenteForm' action="registrarUsuario"
						...
						<div class="form-group ">
							...
							<div class="col-sm-10">
								...
								<label for="login" class="form-control"><c:out value="${docente.nombre}" /></label>
							</div>
						</div>
						...
						<div class="form-group ">
							...
							<div class="col-sm-10">
								<label for="login" class="form-control">${docente.apellidos}</label>
							</div>
						</div>
						...
						<div class="form-group ">
							...
							<div class="col-sm-10">
								<label for="login" class="form-control">${docente.email}</label>
							</div>
						</div>
						...
						<div class="form-group ">
							...
							<a href="cambiar" class="btn btn-primary pull-right">Cambiar
								Contraseña</a>
						</div>
					</form>
				</div>
