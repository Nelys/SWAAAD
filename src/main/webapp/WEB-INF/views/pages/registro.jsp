							...
							<div id="login-access" class="tab-pane fade active in">
								...
								<form name='registroForm' id='registroForm' action="registrarUsuario" method="post" role="form" class="form-horizontal">
									...
									<div class="form-group ">
										<label for="login" class="sr-only">Nombre</label>
										<input type="text" class="form-control" name="nombres" id="nombres" placeholder="Nombres" tabindex="1" value="" required="required"
										/>
									</div>

									<div class="form-group ">
										<label for="login" class="sr-only">Apellidos</label>
										<input type="text" class="form-control" name="apellidos" id="apellidos" placeholder="Apellidos" tabindex="1" value="" required="required"
										/>
									</div>
									...
									<div class="form-group ">
										<fieldset>
											...
											<label class="radio-inline">
												<input type="radio" name="optradio" value="F" checked="checked">Femenino
											</label>
											<label class="radio-inline">
									...
									<div class="form-group ">
										...
										<input type="email" class="form-control" name="email" id="email" placeholder="Email" value="" required="required" />
									</div>
							...
							.bootstrapValidator(
							{
								...
								fields: {
									...
									email: {
										validators: {
											emailAddress: {
												message: 'Np es una dirección de correo electrónico válida'
											}
										}
									},
									apellidos: {
