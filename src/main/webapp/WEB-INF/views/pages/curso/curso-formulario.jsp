	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-6">
				...
				<form:form action="saveCurso" method="post"	modelAttribute="curso" cssClass="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<div class="input-group">
								<input type="text" class="form-control" placeholder="Horario" value="L-V (9:00am - 11:00 am)">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<div class="input-group">
								...
								<span class="input-group-btn">
									<a href="newHorario" class="btn btn-primary" type="button"><i class="glyphicon glyphicon-plus"></i></a>
								</span>
							</div>
						</div>
					</div>
