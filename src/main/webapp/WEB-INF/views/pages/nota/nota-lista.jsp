							...
							<form:form action="saveNota" method="GET" modelAttribute="nota">
								<div class="modal-body">
									...
									<div>
										...
										<form:hidden cssClass="idEvaluacion"
									...
									<!-- 									</span> -->
									<!-- 									<input id="notaEvaluativa" name="notaEvaluativa" class="form-control" type="text" value="1" min="1" max="20" style="text-align: center;"> -->
									<!-- 									<span class="input-group-btn"> -->
									...
									<!-- 								<div class="input-group"> -->
									<!-- 									<button type='button' class='btn btn-danger'>-</button> -->
									<!-- 									<input id="notaEvaluativa" name="notaEvaluativa" type="number" min="0" max="20" /> -->
									<!-- 									<button type='button' class='btn btn-success'>+</button> -->
									<!-- 								</div> -->
									<!-- 							    <div align="center"> -->
