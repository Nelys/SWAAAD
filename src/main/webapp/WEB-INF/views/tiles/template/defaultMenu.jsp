...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
	...
	<div class="navbar-header">
		<button type="button" class="navbar-toggle" data-toggle="collapse"
			...
			<span class="sr-only">Navegacion SWAAAD</span> <span class="icon-bar"></span>
	...
	<ul class="nav navbar-right top-nav">
		...
		<li class="dropdown"><a href="#" class="dropdown-toggle"
			...
			<ul class="dropdown-menu">
				<li><a href="${pageContext.request.contextPath}/perfil"><i
		...
		<ul class="nav navbar-nav side-nav">
			...
			<li class="active"><a
				href="${pageContext.request.contextPath}/cursos" data-target="#demo"><i
					class="fa fa-fw fa-table"></i> Cursos</i></a>
				<ul id="demo">

					<li><a href="${pageContext.request.contextPath}/alumnos">Alumnos</a>
					</li>
					<li><a href="${pageContext.request.contextPath}/listNota">Notas</a>
					</li>
					<li><a href="${pageContext.request.contextPath}/asistencias">Asistencias</a>
					</li>
					<li><a
						href="${pageContext.request.contextPath}/actividades-pedagogicas">Act.Pedagogicas</a>
					</li>
					<li><a href="${pageContext.request.contextPath}/aula-dinamica">Aula
							Dinamica</a></li>
					<!--                             <li> -->
